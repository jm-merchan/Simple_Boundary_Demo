...
locals {
  ...
  worker {
    public_addr = "IP"
    initial_upstreams = ["e088caa2-ad01-af40-2cee-a5bb955ed2fd.proxy.boundary.hashicorp.cloud:9202", "6acb32c6-d94d-afa9-d918-4b16f0d993ee.proxy.boundary.hashicorp.cloud:9202"]
