...
## Build an EC2 and access via Boundary [Scenario 1]
...
## Vault Credential Brokering [Scenario 2]
...
> eval "$(terraform output -raw rds_connect)"
> ```
>
...
## SSH Certificate Injection [Scenario 3]
...
## Self Managed Worker [Scenario 4]
...
## Vault Credential Brokering with K8S [Scenario 6]
